...
**Look editorial premium (ESTÁNDAR APROBADO).** Todo va dentro del `<style>` inline de la guía; nada de CDN ni archivos externos. El esqueleto de referencia es `segmentacion-de-mercados.html`.
