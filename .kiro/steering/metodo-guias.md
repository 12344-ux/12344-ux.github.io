...
**Toda guía nueva usa este layout.** El esqueleto de referencia es `demo/index.html` (la guía demo): **cópiala como base** y reemplaza el contenido. **Mobile-first**: la mayoría estudia en el celular; prueba SIEMPRE en móvil y PC.
